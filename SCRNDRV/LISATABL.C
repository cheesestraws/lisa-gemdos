...
WORD DEV_TAB[45] = {
  	...
  	305,	/* 3	width of pixel			     */
  	415,	/* 4	heigth of pixel			     */
  	1,	/* 5	character sizes			     */
...
WORD MAP_COL[MAX_COLOR] = {0, 15, 1, 2, 4, 6, 3, 5, 7, 8, 9, 10, 12, 14, 11, 13};

WORD REV_MAP_COL[MAX_COLOR] = {0, 2, 3, 6, 4, 7, 5, 8, 9, 10, 11, 14, 12, 15, 13, 1};
